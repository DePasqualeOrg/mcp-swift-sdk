...
extension Server {
    ...
    public func setToolsCapability(_ capability: Capabilities.Tools) {
    ...
    public func setResourcesCapability(_ capability: Capabilities.Resources) {
    ...
    public func setPromptsCapability(_ capability: Capabilities.Prompts) {
    ...
    public func setLoggingCapability(_ capability: Capabilities.Logging) {
